...
print(sum(1 for y in range(len(trees)) for x in range(len(trees[0])) if is_visible(trees, (y,x))))
...
print(max(scenic_score(trees, (y,x)) for y in range(len(trees)) for x in range(len(trees[0]))))
